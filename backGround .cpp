...
{
    string image[4] = {"img/backGroundSprite/BG_origin.png", "img/backGroundSprite/segment_1.png", "img/backGroundSprite/segment_2.png",
                  "img/backGroundSprite/segment_3.png"};
...
void backGround::speedBG(int speed)
{
    segments[1].move(speed + 4, 0);
    segments[2].move(speed + 4, 0);

    segments[3].move(speed + 3, 0);
    segments[4].move(speed + 3, 0);

    segments[5].move(speed + 1, 0);
